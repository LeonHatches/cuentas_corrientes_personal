-- =====================================================================
-- SCRIPT DE CARGA UNIFICADA - TABLAS ASIGNADAS + DATOS NUEVOS
...
-- ---------------------------------------------------------------------
-- 3. CUENTA CORRIENTE (base + NUEVOS tipos 2, 3 y 99)
-- ---------------------------------------------------------------------
...
-- NUEVOS: Tipo Vacacional (2)
(92000001, 100001, 2, 20260101, 3200.00, 3200.00, 'A'),
(92000003, 100003, 2, 20260101, 1800.00, 1800.00, 'A'),
(92000005, 100005, 2, 20260101, 950.00, 950.00, 'A'),
(92000006, 100006, 2, 20260101, 2900.00, 2900.00, 'A'),
(92000007, 100007, 2, 20260101, 1400.00, 1400.00, 'A'),
(92000008, 100008, 2, 20260101, 1100.00, 1100.00, 'A'),
-- NUEVOS: Tipo Salud (3)
(93000001, 100001, 3, 20260101, 4500.00, 4100.00, 'A'),
(93000002, 100002, 3, 20260101, 5000.00, 4800.00, 'A'),
(93000003, 100003, 3, 20260101, 2200.00, 2000.00, 'A'),
(93000004, 100004, 3, 20260101, 3100.00, 3100.00, 'A'),
(93000005, 100005, 3, 20260101, 1500.00, 1250.00, 'A'),
-- NUEVOS: Tipo Otra (99)
(99000001, 100001, 99, 20260101, 12000.00, 12000.00, 'A'),
(99000003, 100003, 99, 20260101, 6500.00, 6500.00, 'A'),
(99000005, 100005, 99, 20260101, 3400.00, 3400.00, 'A'),
(99000008, 100008, 99, 20260101, 4100.00, 4100.00, 'A');
...
-- ---------------------------------------------------------------------
-- 10. DESCUENTO MOV (base + NUEVOS meses 2-6)
-- ---------------------------------------------------------------------
