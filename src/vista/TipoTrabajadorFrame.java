...
import servicio.TipoTrabajadorService;
...
public class TipoTrabajadorFrame extends JFrame {

    private final TipoTrabajadorService service = new TipoTrabajadorService();
    ...
    public TipoTrabajadorFrame() {
        setTitle("Mantenimiento - Tipo Trabajador");
        setSize(930, 800);
    ...
    private void construirInterfaz() {
        ...
        JLabel titulo = new JLabel("R13003 - MANTENIMIENTO DE TIPO TRABAJADOR", SwingConstants.CENTER);
        ...
        panelRegistro.setBorder(crearBordeTitulo("Registro_Tipo_Trabajador"));
        ...
        panelTabla.setBorder(crearBordeTitulo("Tabla_Tipo_Trabajador"));
    ...
    private void cargarTabla() {
        ...
        List<TipoTrabajador> lista = service.obtenerListado();

        for (TipoTrabajador tipo : lista) {
            modeloTabla.addRow(new Object[]{
                    String.valueOf(tipo.getTipTraCod()),
                    tipo.getTipTraNom(),
                    tipo.getTipTraEstReg()
            });
        }
    }
    ...
    private Integer obtenerCodigo() {
        ...
        try {
            ...
            if (codigo <= 0 || codigo > 9) {
                mostrarMensaje("Código inválido. Debe ser un número de 1 dígito (1-9).");
                return null;
            }
