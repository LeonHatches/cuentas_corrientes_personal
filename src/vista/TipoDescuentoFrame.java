...
public class TipoDescuentoFrame extends JFrame {

    private final TipoDescuentoService service = new TipoDescuentoService();
    ...
    private void construirInterfaz() {
        ...
        JLabel titulo = new JLabel("R13007 - MANTENIMIENTO DE TIPO DESCUENTO", SwingConstants.CENTER);
        ...
        panelRegistro.setBorder(crearBordeTitulo("Registro_Tipo_Descuento"));
        ...
        panelTabla.setBorder(crearBordeTitulo("Tabla_Tipo_Descuento"));
    ...
    private void cargarTabla() {
        ...
        List<TipoDescuento> lista = service.obtenerListado();

        for (TipoDescuento tipo : lista) {
            modeloTabla.addRow(new Object[]{
                    tipo.getTipDesCod(),
                    tipo.getTipDesNom(),
                    tipo.getTipDesEstReg()
            });
        }
    }
