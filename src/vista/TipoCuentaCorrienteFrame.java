...
public class TipoCuentaCorrienteFrame extends JFrame {

    private final TipoCuentaCorrienteService service = new TipoCuentaCorrienteService();
    ...
    private void construirInterfaz() {
        ...
        JLabel titulo = new JLabel("R13008 - MANTENIMIENTO DE TIPO CUENTA CORRIENTE", SwingConstants.CENTER);
        ...
        panelRegistro.setBorder(crearBordeTitulo("Registro_Tipo_Cuenta_Corriente"));
        ...
        panelTabla.setBorder(crearBordeTitulo("Tabla_Tipo_Cuenta_Corriente"));
    ...
    private void cargarTabla() {
        ...
        List<TipoCuentaCorriente> lista = service.obtenerListado();

        for (TipoCuentaCorriente tipo : lista) {
            modeloTabla.addRow(new Object[]{
                    String.format("%02d", tipo.getTipCtaCod()),
                    tipo.getTipCtaNom(),
                    tipo.getTipCtaEstReg()
            });
        }
    }
