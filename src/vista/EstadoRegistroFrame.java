...
public class EstadoRegistroFrame extends JFrame {
    ...
    public EstadoRegistroFrame() {
        setTitle("R13001 - Estado de Registro");
        setSize(930, 750);
    ...
    private void construirInterfaz() {
        ...
        JLabel titulo = new JLabel("R13001 - MANTENIMIENTO DE ESTADO DE REGISTRO", SwingConstants.CENTER);
        ...
        panelRegistro.setBorder(crearBordeTitulo("Registro_Estado_Registro"));
        ...
        panelTabla.setBorder(crearBordeTitulo("Tabla_Estado_Registro"));
