...
public class TipoPrestamoFrame extends JFrame {

    private final TipoPrestamoService service = new TipoPrestamoService();
    ...
    private void construirInterfaz() {
        ...
        JLabel titulo = new JLabel("R13005 - MANTENIMIENTO DE TIPO PRÉSTAMO", SwingConstants.CENTER);
        ...
        panelRegistro.setBorder(crearBordeTitulo("Registro_Tipo_Prestamo"));
        ...
        panelTabla.setBorder(crearBordeTitulo("Tabla_Tipo_Prestamo"));
    ...
    private void cargarTabla() {
        ...
        List<TipoPrestamo> lista = service.obtenerListado();

        for (TipoPrestamo tipo : lista) {
            modeloTabla.addRow(new Object[]{
                    String.format("%02d", tipo.getTipPreCod()),
                    tipo.getTipPreNom(),
                    tipo.getTipPreEstReg()
            });
        }
    }
