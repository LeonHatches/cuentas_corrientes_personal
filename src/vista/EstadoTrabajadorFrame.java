...
import servicio.EstadoTrabajadorService;
...
public class EstadoTrabajadorFrame extends JFrame {

    private final EstadoTrabajadorService service = new EstadoTrabajadorService();
    ...
    private void construirInterfaz() {
        ...
        JLabel titulo = new JLabel("R13004 - MANTENIMIENTO DE ESTADO TRABAJADOR", SwingConstants.CENTER);
        ...
        panelRegistro.setBorder(crearBordeTitulo("Registro_Estado_Trabajador"));
        ...
        panelTabla.setBorder(crearBordeTitulo("Tabla_Estado_Trabajador"));
    ...
    private void cargarTabla() {
        ...
        List<EstadoTrabajador> lista = service.obtenerListado();

        for (EstadoTrabajador estado : lista) {
            modeloTabla.addRow(new Object[]{
                    estado.getEstTraCod(),
                    estado.getEstTraNom(),
                    estado.getEstTraEstReg()
            });
        }
    }
