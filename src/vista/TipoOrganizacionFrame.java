...
public class TipoOrganizacionFrame extends JFrame {

    private final TipoOrganizacionService service = new TipoOrganizacionService();
    ...
    public TipoOrganizacionFrame() {
        setTitle("R13002 - Tipo Organización");
        setSize(930, 800);
    ...
    private void construirInterfaz() {
        ...
        JLabel titulo = new JLabel("R13002 - MANTENIMIENTO DE TIPO ORGANIZACIÓN", SwingConstants.CENTER);
        ...
        panelRegistro.setBorder(crearBordeTitulo("Registro_Tipo_Organizacion"));
        ...
        panelTabla.setBorder(crearBordeTitulo("Tabla_Tipo_Organizacion"));
    ...
    private void cargarTabla() {
        ...
        List<TipoOrganizacion> lista = service.obtenerListado();

        for (TipoOrganizacion tipo : lista) {
            modeloTabla.addRow(new Object[]{
                    String.format("%02d", tipo.getTipOrgCod()),
                    tipo.getTipOrgNom(),
                    tipo.getTipOrgEstReg()
            });
        }
    }
    ...
    private Integer obtenerCodigo() {
        ...
        try {
            ...
            if (codigo <= 0 || codigo > 99) {
                mostrarMensaje("Código inválido. Debe ser un número entre 1 y 99.");
                return null;
            }
