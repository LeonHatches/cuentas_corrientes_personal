...
import dao.EstadoTrabajadorDAO;
...
public class EstadoTrabajadorService {
    ...
    private final EstadoTrabajadorDAO dao = new EstadoTrabajadorDAO();

    private int estRegFlaAct = 0;
    private String operacionPendiente = "";
    private EstadoTrabajador registroPendiente = null;
    ...
    public String prepararAdicionar(String codigo, String nombre) {
        ...
        if (!codigoValido(codigo)) {
            return "Código no válido. Use 'A' (Activo) o 'C' (Cesado).";
        }
        ...
        registroPendiente = new EstadoTrabajador(codigo, nombre, "A");
    ...
    public String prepararModificar(String codigo, String nuevoNombre) {
        ...
        EstadoTrabajador encontrado = dao.buscarPorCodigo(codigo);

        if (encontrado == null) {
            return "No existe el código " + codigo + ".";
        }

        registroPendiente = new EstadoTrabajador(
                encontrado.getEstTraCod(),
                nuevoNombre,
                encontrado.getEstTraEstReg()
        );
        ...
        switch (operacionPendiente) {
            ...
            case "MODIFICAR":
                correcto = dao.modificarNombre(
                        registroPendiente.getEstTraCod(),
                        registroPendiente.getEstTraNom()
                );
                break;
            ...
            case "REACTIVAR":
                correcto = dao.cambiarEstadoRegistro(
                        registroPendiente.getEstTraCod(),
                        registroPendiente.getEstTraEstReg()
                );
                break;
    ...
    public List<EstadoTrabajador> obtenerListado() {
    ...
    private boolean codigoValido(String codigo) {
        return "A".equals(codigo) || "C".equals(codigo);
    }
