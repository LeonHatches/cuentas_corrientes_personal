...
public class TipoOrganizacionService {
    ...
    private final TipoOrganizacionDAO dao = new TipoOrganizacionDAO();

    private int estRegFlaAct = 0;
    private String operacionPendiente = "";
    private TipoOrganizacion registroPendiente = null;
    ...
    public String prepararAdicionar(int codigo, String nombre) {
        ...
        registroPendiente = new TipoOrganizacion(codigo, nombre, "A");
    ...
    public String prepararModificar(int codigo, String nuevoNombre) {
        ...
        TipoOrganizacion encontrado = dao.buscarPorCodigo(codigo);

        if (encontrado == null) {
            return "No se encontró el código " + codigo + ".";
        }

        registroPendiente = new TipoOrganizacion(
                encontrado.getTipOrgCod(),
                nuevoNombre,
                encontrado.getTipOrgEstReg()
        );
    ...
    public String actualizar() {
        ...
        switch (operacionPendiente) {
            ...
            case "MODIFICAR":
                correcto = dao.modificarNombre(
                        registroPendiente.getTipOrgCod(),
                        registroPendiente.getTipOrgNom()
                );
                break;
            ...
            case "REACTIVAR":
                correcto = dao.cambiarEstadoRegistro(
                        registroPendiente.getTipOrgCod(),
                        registroPendiente.getTipOrgEstReg()
                );
                break;
        ...
        if (correcto) {
            ...
            return "Error al guardar. Verifique los datos.";
        }
    }
    ...
    public List<TipoOrganizacion> obtenerListado() {
